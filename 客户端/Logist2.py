    ...
    while True:
        ...
        if filename!='':
            with open(filepath, 'rb')as f:
                ...
                a = 'D00001;["' + str(tempid) + '","' + str(temp_groupid) + '","' + filename + '","' + date_time + '"]'
                print(a)
...
#聊天界面
    ...
    #chat1.pushButton_4.clicked.connect(reccc1)
    ...
    chat1.pushButton_4.clicked.connect(recfile)
    recc1.listWidget.clicked.connect(dlfile)
    sys.exit(app.exec_())
